...
const socialLinks = [
  { icon: <FaFacebookF />, url: "https://www.facebook.com/profile.php?id=61594699821083", label: "Facebook" },
  { icon: <FaInstagram />, url: "https://www.instagram.com/smitsoftwaresolutions/", label: "Instagram" },
];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 px-6">
          ...
          >
            ...
            <p className="text-gray-400 mb-8">
              Have a project in mind? Fill the form and we'll get back to you on
              WhatsApp right away.
            </p>
